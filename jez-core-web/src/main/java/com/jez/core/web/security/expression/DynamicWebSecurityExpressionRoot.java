 ...
 */
class DynamicWebSecurityExpressionRoot implements SecurityExpressionOperations {
   ...
   */
  public DynamicWebSecurityExpressionRoot(DynamicAuthorityService dynamicAuthorityService,
